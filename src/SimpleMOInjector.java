...
public class SimpleMOInjector {
	...
	public String paramToUrlString(){
		String result = "http://192.168.43.173:88/inject_mo?";
		
		result = result + "short_message=" + "aaaaaaaa";
		result = result + "&source_addr=" + "11111111";
		result = result + "&destination_addr=" + "2222222222";
